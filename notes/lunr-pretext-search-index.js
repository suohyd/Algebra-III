...
},
{
  ...
  "number": "27",
  "title": "",
  "body": " Keep the notations of the above . If the kernel of the evaluation homomorphism (note that as ring homomorphisms maps unity to unity and that is not a zero ring) then, is a field. Therefore, we ge that  The is nonzero if and only if is a root of some nonzero polynomial in , i.e., is algebraic over .   "
},
{
...
},
{
  ...
  "number": "32",
  "title": "",
  "body": "  Let be a field and let and be two algebraic closures of . Then, there exists an isomorphism such that .   "
},
{
